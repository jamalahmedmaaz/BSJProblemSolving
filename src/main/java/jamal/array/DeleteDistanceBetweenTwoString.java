...
public class DeleteDistanceBetweenTwoString {
    public static void main(String[] args) {
        DeleteDistanceBetweenTwoString deleteDistanceBetweenTwoString = new DeleteDistanceBetweenTwoString();
    ...
    public int d(String str1, String str2) {
        ...
        int n = str1.length();
        int m = str2.length();
        return 1 + Math.min(d(str1.substring(0, n - 1), str2), d(str1, str2.substring(0, m - 1)));
    }
}
